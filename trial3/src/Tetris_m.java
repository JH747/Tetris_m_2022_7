...
public class Tetris_m extends JFrame {
    ...
    static ArrayList<Point> cBlock_loc = new ArrayList<>(); // 현재 block 위치
    ...
    public Tetris_m(){
        ...
        cBlock_loc.add(new Point(9,0));
        cBlock_loc.add(new Point(9,1));
        cBlock_loc.add(new Point(9,2));
        cBlock_loc.add(new Point(10,2));
        // TODO ----------------------------------------
